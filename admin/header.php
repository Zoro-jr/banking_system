          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="newacount"> New Account </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="viewaccount"> View Accounts </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="deposit"> Deposit </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="withdra"> Withdraw </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="transfer">Transaction</a>
                </li>
